  ...
  return (
    <section className="py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="flex items-center" style={{ maxWidth: 720, margin: '12px auto 0', color: '#374151', lineHeight: 1.35, textAlign: 'justify' }}>
        ...
        <h4 className="font-semibold text-gray-900 flex items-center gap-4 mt-6 mb-3" style={{ lineHeight: 1.35 }}>
        ...
        <ul className="space-y-3 mb-10 list-none">
          <li className="flex items-center text-gray-700" style={{ lineHeight: 1.35 }}>
